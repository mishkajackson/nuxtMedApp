...
export default {
  ...
  methods: {
    genderChange(event) {
      this.$store.commit("static/gender", event.target.value);
      console.log(this.$store.state.static.gender);
    },
    codesChange(event) {
